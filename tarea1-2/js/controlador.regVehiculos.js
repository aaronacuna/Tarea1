let botonRegVehiculo = document.querySelector('#btnRegistrarVehiculo');
botonRegVehiculo.addEventListener('click', regVehiculo);
...
function regVehiculo(){
    ...
    objCliente.agregarVehiculo(objCliente);
    actualizarCliente(objVehiculo);
